...
def rendered_page(template, races, classes):
    clases_base = {
        'Волшебник': {
...
def create_card(num, dir_name, rendered_page):
...
def main():
    ...
    for num in range(0, quantity_cards):
        rendered_page = rendered_page(template, races, classes)
        create_card(num, dir_name, rendered_page)
